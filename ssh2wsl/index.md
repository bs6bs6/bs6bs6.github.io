...
同一个局域网下实现Mac ssh连接WSL。

Task.ps1作为定时任务，windows内设置开机执行
...
$wsl2Name = "Ubuntu-22.04" # 设置WSL2镜像的名字
$wsl2PORT = 2222 # 设置WSL2中sshd中的端口
$listenPORT = 2222 # 设置windows监听的端口，访问windows该端口将转发给WSL2中的上面那个端口
# 获取WSL2的eth0的IP地址
